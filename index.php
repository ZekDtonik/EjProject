...
<body>
    <div class="login-dark" style="background-color:rgb(255,255,255);background-image:url(&quot;0&quot;);height:650px;">
        <form method="post" enctype="application/x-www-form-urlencoded" action="/autenticar/">
            ...
            <!-- ==============================  -->
            <div class="form-group"><input class="form-control" type="text" name="email" required="required" placeholder="Email" autofocus="autofocus"></div>
            <div class="form-group"><input class="form-control" type="password" required="required" name="senha" placeholder="Senha"></div>
